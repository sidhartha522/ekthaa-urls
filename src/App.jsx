...
import ViewFreePlans from './pages/ViewFreePlans';
import BusinessApp from './pages/BusinessApp';
import CollaboratedColleges from './pages/CollaboratedColleges';
import ViewPastWork from './pages/ViewPastWork';
    ...
    <div className="app">
      ...
      <Routes>
        ...
        */}
        ...
        <Route path="/view-free-plans" element={<AuthLayout><ViewFreePlans /></AuthLayout>} />
        <Route path="/collaborated-colleges" element={<AuthLayout><CollaboratedColleges /></AuthLayout>} />
        <Route path="/view-past-work" element={<AuthLayout><ViewPastWork /></AuthLayout>} />
