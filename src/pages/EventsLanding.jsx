            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-teal-50 via-white to-orange-50">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 md:py-32 text-center">
                    ...
                    <div className="flex flex-col items-center gap-4 justify-center">
                        ...
                        <button onClick={() => navigate('/collaborated-colleges')} className="border-2 border-brand-teal text-brand-teal font-semibold px-8 py-4 rounded-full text-lg hover:bg-teal-50 transition-all">
                            Collaborated Colleges List
                        </button>
                    </div>
                </div>
                {/* decorative blobs */}
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {plans.map((plan, i) => (
                            <div key={i} className={`relative bg-white rounded-2xl p-6 border-2 ${plan.color} shadow-sm hover:shadow-lg transition-shadow flex flex-col`}>
                                ...
                                {plan.name === 'Free Plan' && (
                                    <button
                                        className="mt-3 block w-full text-center border-2 border-brand-teal text-brand-teal font-semibold py-2.5 rounded-full hover:bg-teal-50 transition-all text-sm"
                                        onClick={() => navigate('/view-free-plans')}
                                    >
                                        View Free Plans
                                    </button>
                                )}
            ...
            <section id="contact" className="py-20 md:py-28 bg-gradient-to-br from-teal-600 to-teal-700 text-white text-center">
                <div className="max-w-3xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <button 
                            onClick={() => navigate('/view-past-work')}
                            className="inline-block border-2 border-white text-white font-bold px-10 py-4 rounded-full text-lg hover:bg-white hover:text-brand-teal transition-all shadow-xl"
                        >
                            View Past Work
                        </button>
                    </div>
